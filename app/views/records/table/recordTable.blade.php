<table class="table  table-grid  editable-table  js-record-table  js-editable-table  js-modal-table">
    <thead>
    <tr>
...
<!--
    <tr class="split-transaction-row  js-hidden">
        <td colspan="24" class="well">
            <p>This row is hidden for good purposes.</p>

            <p>
                <button type="button" class="btn btn-success"><i class="glyphicon-ok"></i> Split Transaction</button>
                or <a href="#">close</a></p>
        </td>
    </tr>
-->
