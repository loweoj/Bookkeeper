<div class="modal  fade  js-ajax-modal" id="createRecordModal" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            {{ Form::open(['route' => 'records.create', 'class' => 'form-horizontal  js-ajax-form-createItem']) }}
            ...
            <div class="modal-body">
                <div class="modal-body">
                    <div class="form-group @if($errors->has('type')) has-error @endif">
                        ...
                        {{ $errors->first('type', '<span class="help-block  col-sm-offset-3  col-sm-9">:message</span>') }}
                    </div>
                    ...
                    <div class="form-group @if($errors->has('payee')) has-error @endif">
                        ...
                        {{ $errors->first('payee', '<span class="help-block  col-sm-offset-3  col-sm-9">:message</span>') }}
                    </div>
                    <div class="form-group @if($errors->has('description')) has-error @endif">
                        {{ Form::label('description', 'Description', ['class'=>'col-sm-3  control-label']) }}
                        <div class="col-sm-9">{{ Form::text('description', null, ['class'=>'form-control']) }}</div>
                        {{ $errors->first('description', '<span class="help-block  col-sm-offset-3  col-sm-9">:message</span>') }}
                    </div>
                    <div class="form-group @if($errors->has('amount')) has-error @endif">
                        ...
                        {{ $errors->first('amount', '<span class="help-block  col-sm-offset-3  col-sm-9">:message</span>') }}
                    </div>
                    <div class="form-group @if($errors->has('category')) has-error @endif" data-category-income>
                        ...
                        <div class="col-sm-5">{{ Form::select('category_id', $categories, 1, ['class' => 'form-control', 'data-editable-input']) }}</div>
                        {{ $errors->first('category', '<span class="help-block  col-sm-offset-3  col-sm-9">:message</span>') }}
                    </div>
                    <div class="form-group @if($errors->has('stream')) has-error @endif" data-category-income>
                        {{ Form::label('stream_id', 'Stream', ['class'=>'col-sm-3  control-label']) }}
                        <div class="col-sm-5">{{ Form::select('stream_id', $streams, 1, ['class' => 'form-control', 'data-editable-input']) }}</div>
                        {{ $errors->first('stream', '<span class="help-block  col-sm-offset-3  col-sm-9">:message</span>') }}
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                {{ Form::hidden('editId', '') }}
                {{ Form::input('submit', 'create-one', 'Create Record', ['class'=>'btn  btn-primary']) }}
